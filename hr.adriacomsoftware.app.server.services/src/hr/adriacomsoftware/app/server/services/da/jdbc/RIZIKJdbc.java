...
import hr.adriacomsoftware.app.server.services.J2EERIZIKJDBCService;
import hr.as2.inf.server.connections.jdbc.J2EEConnectionJDBC;


public class RIZIKJdbc extends BankarskiJdbc {
    public RIZIKJdbc() {
        //setTableName("");
    }
    public J2EEConnectionJDBC getConnection() {
        try {
            return (J2EEConnectionJDBC) J2EERIZIKJDBCService.getInstance().getConnection();
        } catch (Exception e) {
