...
public final class NaplataGrKreditiPovijestJdbc extends CMDBJdbc {
    public NaplataGrKreditiPovijestJdbc() {
        setTableName("j2ee_audit");
    }

    public NaplataGrKreditiRs daoProcitajPovijestPolja(NaplataGrKreditiVo value) {
		...
		try{
			...
			pstmt.close();
			return new NaplataGrKreditiRs(j2eers);
		} catch (Exception e) {
