...
public class J2EECRMJDBCService extends J2EEPersistentService {
	static private J2EECRMJDBCService _instance = null;
public J2EECRMJDBCService() {
	super();
...
public static J2EECRMJDBCService getInstance(){
	if(_instance==null)
		_instance = new J2EECRMJDBCService();
	return _instance;
}
}
