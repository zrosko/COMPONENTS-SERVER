...
import hr.adriacomsoftware.app.server.services.J2EECRMJDBCService;
import hr.as2.inf.server.connections.jdbc.J2EEConnectionJDBC;


public class CRMJdbc extends BankarskiJdbc {
    public CRMJdbc() {
        //setTableName("test");
    }
    public J2EEConnectionJDBC getConnection() {
        try {
            return (J2EEConnectionJDBC) J2EECRMJDBCService.getInstance().getConnection();
        } catch (Exception e) {
