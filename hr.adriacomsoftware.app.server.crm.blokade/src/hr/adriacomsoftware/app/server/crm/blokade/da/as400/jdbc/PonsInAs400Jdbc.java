...
public final class PonsInAs400Jdbc extends J2EEDataAccessObjectAs400Jdbc {
	public PonsInAs400Jdbc() {
		setTableName("BSADB.PONS_IN"); // produkcija
	}

	public AS2RecordList daoListajPoruke(OsnovniVo value) {
		J2EESqlBuilder sql = new J2EESqlBuilder();
		sql.appendln("SELECT *");
		sql.appendln("FROM BSADB.PONS_IN ");
